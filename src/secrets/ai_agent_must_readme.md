...
in the LLM context — actual values only exist in `.forkscout/vault.enc.json` (AES-256-GCM) and
...
- Vault file (`.forkscout/vault.enc.json`) is gitignored — never commit it
