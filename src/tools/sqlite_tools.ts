...
//
// Each named database is a separate .sqlite file under .agents/db/.
...
//   list_databases — list all .sqlite files in .agents/db/
...
const DB_DIR = join(process.cwd(), ".agents", "db");
...
export const sqlite_tools = tool({
    description:
        "Persistent structured storage using SQLite. Databases live in .agents/db/<name>.sqlite and survive agent restarts. " +
