...
// File: .forkscout/activity.log (project root)
...
const LOG_DIR = resolve(__dirname, "..", "..", ".forkscout");
const LOG_FILE = resolve(LOG_DIR, "activity.log");

// Ensure .forkscout/ dir always exists
...
/**
 * Append a single activity event to .forkscout/activity.log.
