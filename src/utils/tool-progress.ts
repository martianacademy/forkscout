...
export const TOOL_LABELS: Record<string, string> = {
    ...
    memory__recall: "Memory recall",
    memory__remember: "Saving to memory",
    memory__relate: "Linking memory",
    memory__observe: "Observing",
    memory__task: "Task management",
    memory__context: "Loading context",
    memory__consolidate: "Consolidating memory",
    memory__introspect: "Inspecting memory",
    load_skill_tools: "Loading skill",
